...
{
    public class AlmacenadorDeArchivosLocal : IAlmacenadorArchivos
    {
        private readonly IWebHostEnvironment env;
        private readonly IHttpContextAccessor httpContextAccessor;

        public AlmacenadorDeArchivosLocal(IWebHostEnvironment env, 
            ...
            string contenedor, string contentType)
        {
            ...
            var urlPraBD = Path.Combine(urlActual, contenedor, nombreArchivo).Replace("\\", "//");
            return urlPraBD;
        }
    }
}